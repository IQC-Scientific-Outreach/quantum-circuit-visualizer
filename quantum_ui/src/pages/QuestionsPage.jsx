...
function FinalScreen({ scores, questions, onRetry }) {
  ...
  return (
    <div className="fixed inset-0 bg-slate-950 text-slate-300 flex flex-col items-center justify-center font-sans gap-6 p-8" style={{ colorScheme: 'dark' }}>
...
export default function QuestionsPage() {
  ...
  return (
    <div className="fixed inset-0 flex flex-col font-sans text-slate-300 bg-slate-950" style={{ colorScheme: 'dark' }}>
